...
<div style = 'font-size:50px; color:white; position: absolute; left:30%; top:30%;'>Comenzi plasate pe intervale de timp </div>
...
<div> 
<form method = 'post' action = 'comenziInterval.php'>
...
<input type = 'date' id = 'dataSfarsitID' name = 'dataSfarsit' required style = 'position:absolute; top:50%; left:60%; font-size:25px; background-color: #921f1c; cursor:pointer; padding:7px; border-radius:10px;  color:white; box-shadow: 0px 12px 16px 0px rgba(0,0,0,0.24), 0 17px 50px 0 rgba(0,0,0,0.19); border: none;'>
