...
<input type = 'text' placeholder = 'Nume sofer' class ='email' name = 'numeSofer' required>
<input type = 'tel' placeholder = 'Numar telefon' class ='username' name= 'telefonSofer' pattern = '[0]{1}[1-9]{9}' required>"; 
...
echo "<input type = 'submit' class ='signup'  value ='Introduce' name = 'submitAddSoferi'>
</form>
</div> ";
	...
	$(function(){
		$('.signup').click(function(e){
            ...
            var $reper = $(this).closest(".formsignup");
              ...
              var telefon = $reper.find(".username").val();
              var oras = $reper.find(".password").val();
				...
				$.ajax({
					type: 'POST',
					url: 'AddSoferiAdmin.php',
					data: {numesofer_ajax: numesofer, telefon_ajax: telefon, oras_ajax: oras},
					...
					Swal.fire({ 
                                ...
                                'icon': 'error',
								'title': 'Eroare',
								'text': 'Soferul nu a fost adaugat!'
