...
echo "<div style = 'font-size:50px; color:white; position: absolute; left:25%; top:30%;'> Lista utilizatori cu cel putin o comanda efectuata </div>";
...
$queryUseri = "SELECT u.username, u.email, u.data_Inregistrare FROM utilizatori u  WHERE EXISTS (SELECT * FROM comenzi c WHERE u.id_utilizatori = c.id_utilizatori ) ;";
...
echo "<div style = 'font-size:50px; color:white; position: relative; left:25%; top:70%; display:table; '>Numar utilizatori: $numarUseri </div>";
echo "</div>";
