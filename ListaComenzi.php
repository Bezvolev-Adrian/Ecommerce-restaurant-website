...
echo "<div style = 'font-size:50px; color:white; position: absolute; left:40%; top:30%;'> Lista comenzi </div>";
...
$queryUseri = "SELECT c.id_comenzi, c.costCos, c.status_Comanda, c.data_Comanda, u.username, h.metoda_plata FROM comenzi as c INNER JOIN utilizatori as u ON c.id_utilizatori = u.id_utilizatori INNER JOIN metode_plata as h ON c.id_metoda_plata = h.id_metoda_plata;";
