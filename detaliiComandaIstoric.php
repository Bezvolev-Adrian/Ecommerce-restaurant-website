 ...
 <div>
    ...
    <nav class ='baradenavigatie'> 
        <ul class = 'baradenavigatielista'>
            ...
            <li ><a href='IstoricComenzi.php'>Istoric comenzi</a></li>
...
$numarComanda = $_GET['NrComanda'];

echo "<div style = 'font-size:50px; color:white; position: absolute; left:35%; top:30%;'> Detalii comanda : #$numarComanda</div>";
