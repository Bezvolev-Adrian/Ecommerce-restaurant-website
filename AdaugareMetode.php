...
<input type = 'text' placeholder = 'Metoda de plata' class ='email' name = 'denumire' required>
<input type = 'submit' class ='signup'  value ='Introduce' name = 'submitMetode'>
</form>
</div>
		...
		$('.signup').click(function(e){
            ...
            var $reper = $(this).closest(".formsignup");
              ...
              var denumiremetoda= $reper.find(".email").val();
				...
				$.ajax({
					type: 'POST',
					url: 'AddMetodeAdmin.php',
					data: {denumiremetoda_ajax: denumiremetoda},
					...
					Swal.fire({ 
                                'icon': 'success',
								'title': 'Metoda de plata adaugata',
								'text': 'Metoda de plata a fost adaugata!',
                                ...
                                'icon': 'error',
								'title': 'Eroare',
								'text': 'Metoda de plata nu a fost adaugata!'
